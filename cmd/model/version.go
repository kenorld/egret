...
var frameworkCompatibleRangeList = [][]string{
	{"0.0.0", "0.20.0"},   // minimum Egret version to use with this version of the tool
...
func (v *Version) CompatibleFramework(c *CommandConfig) error {
	...
	return errors.New("Tool out of date - do a 'go get -u github.com/kenorld/egret/cmd/egret'")
}
